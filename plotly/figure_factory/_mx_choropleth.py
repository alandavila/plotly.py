...
def _create_us_counties_df(st_to_state_name_dict, state_to_st_dict):
    ...
    gdf = gdf.rename(columns={'NAME_2': 'COUNTY_NAME'})

    gdf_reduced = gdf[['FIPS', 'ID_1', 'COUNTY_NAME', 'geometry']]
    gdf_statefp = gdf_reduced.merge(df_state[['ID_1', 'STATE_NAME']],
                                    on='ID_1')
...
def create_mx_choropleth(fips, values, scope=['mex'], binning_endpoints=None,
